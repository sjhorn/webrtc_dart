...
void main() {
  group('SrtpSession', () {
    ...
    test('construction with valid parameters', () {
      ...
      expect(session.profile, equals(SrtpProtectionProfile.srtpAes128CmHmacSha1_80));
  ...
  group('SrtpSession.fromKeyMaterial', () {
    ...
    test('handles srtpAes128CmHmacSha1_32 profile', () {
      ...
      expect(session.profile, equals(SrtpProtectionProfile.srtpAes128CmHmacSha1_32));
    });
  });
}
