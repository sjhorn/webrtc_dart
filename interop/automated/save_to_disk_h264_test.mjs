/**
 * Automated Save to Disk H.264 Browser Test using Playwright
 *
 * Tests WebRTC H.264 video recording:
 * - Browser sends H.264 camera video to Dart
 ...
 *   dart run interop/automated/save_to_disk_h264_server.dart
 *
 *   # Then run browser tests:
 *   node interop/automated/save_to_disk_h264_test.mjs [chrome|firefox|webkit|all]
 *
